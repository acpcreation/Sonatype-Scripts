...
competitorSBOM = "input/nxc-webgoat-legacy-build-bom.xml"
competitorSBOM = "input/nxc-webgoat-legacy-bom.xml"
sonatypeSBOM = "input/nxc-webgoat-legacy-stagerelease-bom.xml"
appShort = "WebGoat"
...
csvOutputFile = "output/csv-data-comparison-" + appShort + "-SBOM.csv"
jsonOutputFile = "output/data-comparison-" + appShort + "-SBOM.json"
...
def import_reports():
    ...
    print("Found by Sonatype " + str(len(cCompD)))
