...
competitorFile = "../processedFiles/jfrog/dependency-check-report-processed-" + prework_settings.appShort + "-jfrog.csv"

competitorLicenseExport = "../input/jfrog/jfrog-" + prework_settings.appShort + "-license-export.csv"
mvnProcessedFile = "../processedFiles/prework/mvn-depend-processed-" + prework_settings.appShort + ".txt"
outputFile = "../output/prework/mvn-comparison-" + prework_settings.appShort + "-jfrog.json"
...
def import_reports():
    ...
    jf = open(competitorLicenseExport, "r")
...
def compare_components():
 ...
 #       string = competitorData[i]
 #       if competitorData[i].startswith("com.fasterxml.jackson.core:jackson-core"):
 #           print("Stop here!!")
...
def main(e):
    ...
    global mvnProcessedFile, competitorLicenseExport
    competitorLicenseExport = e["competitorLicenseExport"]
...
if __name__ == "__main__":
    main({
        "competitorLicenseExport": competitorLicenseExport,
