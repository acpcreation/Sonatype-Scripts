...
iqPassword = "admin!23" # Password for Sonatype IQ Server
iqOrganizationID = "a9c1ec1ba4da4dc4bb9ab693ac482df8" # Orgs & Policies > Choose the organization you want > Actions > Copy Org ID to Clipboard
selectedSCM = "azure" # Values (currently only 1): azure
getSCMProjectsURL = "https://dev.azure.com/aplattel/_apis/git/repositories?api-version=7.1-preview.1" # Source Control URL
scmUsername = "aplattel@sonatype.com" # Source Control Username
scmAuthToken = "ypyul2url4mzpj6wlxwfl5qslxt7kb5ucye6s2e3b3z2dd45w5hq" # Source Control Access Token (Needs Permissions: https://help.sonatype.com/iqserver/integrations/nexus-iq-for-scm/source-control-configuration-overview)
